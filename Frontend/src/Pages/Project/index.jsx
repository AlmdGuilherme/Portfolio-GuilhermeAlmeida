              ...
              <div className="w-1/2 flex flex-col justify-between py-1">
                <div className="flex flex-col gap-3">
                  ...
                  <div className="text-xs text-[#94A3B8] font-light flex items-center gap-2">
                    ...
                    <span className="text-purple-400 font-medium">{state?.data?.parceiro || "Sem cliente"}</span>
                  </div>
            ...
            <div className="flex flex-col gap-6 max-w-[none]">
              ...
              {state?.data?.lista_contribuicao && state.data.lista_contribuicao.length > 0 && (
                <div className="flex flex-col gap-3 pl-3">
                  <h3 className="text-sm font-medium tracking-widest text-[#94A3B8]">
              ...
              <div className="flex gap-4 flex-wrap">
                {state?.data?.techs && state?.data?.techs.map((tech, index) => (
                  <span
                    key={index}
                    className="inline-flex items-center w-fit text-xs font-medium text-blue-400 bg-blue-950/40 px-3 py-1 rounded-full border border-blue-800/60 select-none backdrop-blur-sm"
                  >
                    {tech}
                  </span>
                ))}
